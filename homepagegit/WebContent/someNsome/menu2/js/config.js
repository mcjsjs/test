		...
		initDesktop : function() {
			...
			_.objects.window._parallelism_update = function() {
				...
				window.setTimeout(function() {
					$SZ.css('height', _.objects.main.outerHeight()).css('top',_.objects.main.offset().top);}, _.settings.introDelay);
				};
			...
			_.objects.items.each(function(i) {
				...
				// Item
				$item.css('position', 'relative').css('width', w).css('height', h);
